...
class OAuthRequest {/*{{{*/
   ...
   */
  public static function from_request($http_method=NULL, $http_url=NULL, $parameters=NULL, $check_contenttype=false) {/*{{{*/
    ...
    if ($parameters) {
      ...
      $req_parameters = $_GET;
      if ($http_method == "POST" && ($check_contenttype || @strstr($request_headers["Content-Type"], "application/x-www-form-urlencoded")) ) {
